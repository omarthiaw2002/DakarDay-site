    ...
    <nav class="bg-white shadow-md sticky top-0 z-50">
        <div class="container mx-auto px-4 py-1 flex justify-between items-center">
            ...
            <div class="flex items-center space-x-4">
                <div class="relative">
                    <button id="cart-btn" class="text-gray-700 hover:text-blue-500 relative">
                        <i class="fas fa-shopping-cart text-xl"></i>
                        <span id="cart-count" class="cart-badge hidden">0</span>
                    </button>
                    <!-- Panier dropdown -->
                    <div id="cart-dropdown" class="hidden absolute right-0 mt-2 w-72 bg-white rounded-md shadow-xl z-50 p-4">
                        <h4 class="font-semibold text-gray-700 border-b pb-2">Votre Panier</h4>
                        <div id="cart-items-container" class="py-2 max-h-60 overflow-y-auto">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="product-card bg-white rounded-lg overflow-hidden shadow-md">
                    ...
                    <div class="p-4">
                        <h3 class="font-semibold text-lg mb-1">Smartphone Premium</h3>
                        <div class="flex items-center mb-2">
                            ...
                            <span class="text-gray-600 text-sm ml-2">(24 avis)</span>
                        </div>
                ...
                <div class="product-card bg-white rounded-lg overflow-hidden shadow-md">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex items-center mb-2">
                            ...
                            <span class="text-gray-600 text-sm ml-2">(18 avis)</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <div>
                ...
                <div class="product-card bg-white rounded-lg overflow-hidden shadow-md">
                    ...
                    <div class="p-4">
                        <h3 class="font-semibold text-lg mb-1">Casque Audio Sans Fil</h3>
                        <div class="flex items-center mb-2">
                            <div class="flex text-yellow-400">
                                <i class="fas fa-star"></i>
                                <i class="fas fa-star"></i>
                            ...
                            <span class="text-gray-600 text-sm ml-2">(45 avis)</span>
                        </div>
                        <div class="flex items-center justify-between">
                            <div>
            ...
            <div class="text-center mt-10">
                <a href="tout.html" class="inline-block px-6 py-3 bg-white border border-blue-500 text-blue-500 rounded-full font-semibold hover:bg-blue-50 transition duration-300">Voir tous les produits</a>
            </div>
        </div>
    </section>
 ...
 <!-- À propos -->
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row items-center">
                <div class="md:w-1/2 mb-8 md:mb-0">
                    <img src="https://images.unsplash.com/photo-1556740738-b6a63e27c4df?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1170&q=80" alt="Notre équipe" class="rounded-lg shadow-xl w-full max-w-md mx-auto">
                </div>
                <div class="md:w-1/2 md:pl-12">
                    <h2 class="text-3xl font-bold mb-6">À propos de Dakar Day</h2>
                    <p class="text-gray-600 mb-4">Fondée en 2025, Dakar Day est devenue une référence dans le commerce en ligne, offrant à ses clients une expérience d'achat exceptionnelle.</p>
                    <p class="text-gray-600 mb-6">Notre mission est de proposer des produits de qualité à des prix compétitifs, tout en offrant un service client exemplaire.</p>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold mb-1">Retours Faciles</h4>
                                <p class="text-gray-600 text-sm">15 jours pour changer d'avis</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold mb-1">Paiement Sécurisé</h4>
                                <p class="text-gray-600 text-sm">Transactions 100% sécurisées</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h4 class="font-semibold mb-1">Support 24/7</h4>
    ...
    <section id="promotions" class="py-16 bg-gradient-to-r from-purple-500 to-blue-600 text-white">
        <div class="container mx-auto px-4">
            ...
            <p class="text-center mb-12 max-w-2xl mx-auto">Profitez de nos offres spéciales limitées dans le temps. Ne manquez pas ces bonnes affaires!</p>
            
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <!-- Offre 1 -->
                <div class="bg-white bg-opacity-10 backdrop-filter backdrop-blur-sm rounded-xl p-6 border border-white border-opacity-20">
                    <div class="text-center mb-6">
                        <div class="inline-block bg-red-500 text-white text-xs font-bold px-3 py-1 rounded-full mb-4">-30%</div>
                    ...
                    <div class="flex justify-center">
                        <button class="bg-white text-purple-600 px-6 py-2 rounded-full font-semibold hover:bg-gray-100 transition duration-300">Acheter maintenant</button>
                    </div>
                </div>
                ...
                <div class="bg-white bg-opacity-10 backdrop-filter backdrop-blur-sm rounded-xl p-6 border border-white border-opacity-20">
                    <div class="text-center mb-6">
                        <div class="inline-block bg-yellow-500 text-white text-xs font-bold px-3 py-1 rounded-full mb-4">Bundle</div>
                ...
                <div class="bg-white bg-opacity-10 backdrop-filter backdrop-blur-sm rounded-xl p-6 border border-white border-opacity-20">
                    <div class="text-center mb-6">
                        <div class="inline-block bg-green-500 text-white text-xs font-bold px-3 py-1 rounded-full mb-4">Meilleur prix</div>
    ...
    <section class="py-16 bg-gray-50">
        <div class="container mx-auto px-4">
            ...
            <p class="text-center text-gray-600 mb-12 max-w-2xl mx-auto">Nos clients sont notre priorité numéro un. Voici ce qu'ils pensent de notre boutique.</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p class="text-gray-600">"J'ai commandé un smartphone et j'ai été impressionnée par la rapidité de la livraison. Le produit était parfaitement emballé et correspondait exactement à la description. Je recommande vivement!"</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p class="text-gray-600">"Service client exceptionnel! J'ai eu un problème avec ma commande et ils ont répondu immédiatement et résolu le problème en moins de 24 heures. C'est rare d'avoir un tel service aujourd'hui."</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <p class="text-gray-600">"J'adore cette boutique! Les prix sont compétitifs, la sélection est excellente et les promotions sont vraiment intéressantes. Je suis devenue une cliente fidèle."</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="panier" class="py-16 bg-gray-50 hidden">
        <div class="container mx-auto px-4">
            <h2 class="text-3xl font-bold mb-8">Votre Panier</h2>
    ...
    <footer class="bg-gray-800 text-white pt-12 pb-6">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                <div>
                    <h3 class="text-xl font-bold mb-4">Dakar Day</h3>
                ...
                <div>
                    ...
                    <p class="text-gray-400 mb-2">Abonnez-vous pour ne rien manquer de nos offres spéciales.</p>
                    <form class="flex">
                        <input type="email" placeholder="Votre email" class="px-3 py-2 rounded-l text-gray-800 focus:outline-none w-full">
                        <button type="submit" class="bg-blue-500 px-3 py-2 rounded-r hover:bg-blue-600">
            ...
            <div class="border-t border-gray-700 pt-6 flex flex-col md:flex-row justify-between items-center">
                <p class="text-gray-400 text-sm">&copy; 2023 Dakar Day. Tous droits réservés.</p>
            ...
            document.querySelectorAll('a[href^="#"]').forEach(anchor => {
                anchor.addEventListener('click', function(e) {
                    if (this.getAttribute('href') !== '#') {
                        ...
                        if (targetElement) {
                            // Si c'est la section panier (qui est cachée par défaut)
                            if (targetId === '#panier') {
